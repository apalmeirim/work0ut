...
Download the latest Windows installer from the repository releases or from the packaged installer included with the project, then run the `.exe` file and complete the installer steps. On first launch, sign in or create an account using your email and password credentials.
